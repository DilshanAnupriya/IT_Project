...
import { FaUsers, FaRegCalendarAlt } from "react-icons/fa"; // Icons for Employees and Availability
import { RiFileUserLine } from "react-icons/ri"; // Icon for Recruitments
import { MdLogout } from "react-icons/md";
import "../../Pages/Css/ComponentsCss/EmployeeDash/EmployeeDash.css"
                ...
                <div className="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
                    <ul className="titles flex flex-col pl-0 mb-0">
                        <li className="mt-0.5 w-full">
                            <Link to="/EmpDash" className="py-2.7 bg-blue-500/13 dark:text-black dark:opacity-80 text-sm  my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700  hover:text-[#6B75FE]" href="../pages/dashboard.html">
                        ...
                        <li className="mt-0.5 w-full">
                            <Link to="/EmpReqFormDis" className=" dark:text-black dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors hover:text-[#6B75FE]" href="../pages/virtual-reality.html">
                                <div className="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
