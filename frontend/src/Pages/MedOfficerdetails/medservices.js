...
import "../../Pages/Css/MedOfficercss/medservicescss.css"
    ...
    <div className="our-medical-services">
      ...
      <div className="container5">
        <div className="section-title">
          ...
          <p>Our goal is to serve you with the best medical services</p>
        </div>

        <div className="services-grid">
          <div className="service-item">
            <div className="icon">
              <img src={m5} alt="Fulled with medical Resources" />
            </div>
          ...
          <div className="service-item">
            <div className="icon">
              <img src={m3} alt="Get Informed" />
            </div>
            <Link to=""> <h3>Get Informed</h3></Link>
          </div>

          <div className="service-item">
            <div className="icon">
              <img src={m1} alt="Special Treatments" />
            </div>
           <Link to=""> <h3>Special Treatments</h3> </Link>
          </div>
