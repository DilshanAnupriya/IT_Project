...
import backgroundImage from '../../Assets/Medical/b2.jpg'; // Adjust the path as necessary
    ...
    <div className="flex">
      ...
      >
        ...
        <div className="flex-1 ml-8">
          <h1 className="text-2xl font-bold text-white mb-4">Lunch Items</h1>
          <button
          ...
          <div className="h-96 overflow-y-auto">
            {lunchData.map((item) => (
              <div key={item._id} className="mb-4">
                ...
                >
                  {item.LNutrition_title}
                </button>
                {selectedItem && selectedItem._id === item._id && (
                  <div className="mt-2 bg-white py-2 px-4 rounded shadow-lg">
                    <p className="text-gray-700">{item.LNutrition_description}</p>
