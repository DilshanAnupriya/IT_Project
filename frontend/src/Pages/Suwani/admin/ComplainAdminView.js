...
import Sidebar from '../../../Components/Suwani/Sidebar.js';
import Navbar_profile from '../../../Components/Suwani/Navbar_profile.js';
          ...
          <div className="bg-transparent shadow-lg p-6 rounded-lg flex-1">
            ...
            {complaints.length > visibleCount && (
              <button
                ...
                className="bg-[#6B75FE] text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-colors"
              >
                Read More
              </button>
            )}
